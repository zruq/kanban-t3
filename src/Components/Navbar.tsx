...
type NavbarProps = { showSideBar: boolean; boardName: string };
const Navbar = ({ showSideBar, boardName }: NavbarProps) => {
  return (
    <div className="flex  h-16 w-full items-center justify-between border-b border-linesLight bg-white p-6 dark:border-linesDark dark:bg-darkGrey tablet:h-[5rem] desktop:h-[6rem]">
      ...
      <div className="flex items-center justify-evenly">
        <Button cType="primaryL" className="mr-4 block w-[10.25rem]">
          + Add New Task
        </Button>
        <svg
          width="5"
