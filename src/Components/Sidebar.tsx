    ...
    <div className="flex h-screen w-[18.75rem] flex-col items-start justify-between bg-white p-8 dark:bg-darkGrey ">
      <div className="h-90%">
        ...
        <div className="mt-[3.375rem]">
          ...
          <div className="-ml-14 max-h-[calc(100vh-21rem)] overflow-x-hidden overflow-y-scroll ">
            {boards.map((board) => (
              <Button
                cType={currentBoard === board ? "primaryL" : "ghost"}
                key={board}
                className="group  flex w-[18rem] pl-14 capitalize"
              >
                <svg
                  width="16"
                  height="16"
          ...
          <Button
            cType={"ghost"}
            className="group -ml-14 flex w-[18rem] pl-14 "
          >
            <svg
              width="16"
              height="16"
